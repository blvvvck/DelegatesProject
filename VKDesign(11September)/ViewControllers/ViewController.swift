...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, DataTransferProtocol {
    ...
    func randomNews() {
        let news1 = News(text: newsTextArray[0], image: newsImageArray[0], likesCount: newsLikesArray[0], commentsCount:newsCommentsArray[0], repostsCount: newsRepostsArray[0], name: nameLabel.text!, surname: surnameLabel.text!, date: newsDateArray[Int(arc4random_uniform(UInt32(newsDateArray.count)))] )
        let news2 = News(text: newsTextArray[1], image: newsImageArray[1], likesCount: newsLikesArray[1], commentsCount:newsCommentsArray[1], repostsCount: newsRepostsArray[1], name: nameLabel.text!, surname: surnameLabel.text!, date: newsDateArray[Int(arc4random_uniform(UInt32(newsDateArray.count)))])
        let news3 = News(text: newsTextArray[2], image: newsImageArray[2], likesCount: newsLikesArray[2], commentsCount:newsCommentsArray[2], repostsCount: newsRepostsArray[2], name: nameLabel.text!, surname: surnameLabel.text!, date: newsDateArray[Int(arc4random_uniform(UInt32(newsDateArray.count)))])
